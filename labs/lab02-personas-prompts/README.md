...
personas = {
    "Pirate": "You are a pirate captain. Speak like a pirate. End with 'Arrr!'",
    "Haiku Poet": "Answer every question as a haiku (5-7-5 syllables). Never break format.",
